...
//      OidcAuthenticationToken token = edu.iu.uits.lms.lti.config.TestUtils.buildToken("userId", "asdf", LTIConstants.BASE_USER_ROLE);
//
...
//      OidcAuthenticationToken token = edu.iu.uits.lms.lti.config.TestUtils.buildToken("userId", "1234", LTIConstants.BASE_USER_ROLE);
//
//      SecurityContextHolder.getContext().setAuthentication(token);
//
